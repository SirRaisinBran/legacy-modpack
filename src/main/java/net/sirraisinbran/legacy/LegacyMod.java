...
public class LegacyMod implements ModInitializer {
	...
	// Uwu Item Groups
	public static final OwoItemGroup OTHERWORLD_GROUP = new OwoItemGroup(new Identifier(LegacyMod.MOD_ID, "otherworld_group")) {
		@Override
		protected void setup() {
			keepStaticTitle();

			addTab(Icon.of(LegacyBlocks.CHISELED_REDSPOT), "building", null);
			addTab(Icon.of(LegacyBlocks.CYAN_MUSHROOM), "decoration", null);
			addTab(Icon.of(LegacyItems.ESCENCE), "incantation", null);
			addTab(Icon.of(LegacyBlocks.LARGE_EGG), "miscellaneous", null);
		...
		public ItemStack createIcon() {
			return new ItemStack(LegacyBlocks.LUSH_SOIL);
		}
	};
	...
	public void onInitialize() {
		...
		BlockRenderLayerMap.INSTANCE.putBlock(LegacyBlocks.COOKSONIA_PLANT, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(LegacyBlocks.CRY_VIOLET_FLOWER, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(LegacyBlocks.SILPHIUM_FLOWER, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(LegacyBlocks.THISMIA_PLANT, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(LegacyBlocks.THISMIA_PLANT, RenderLayer.getTranslucent());
		BlockRenderLayerMap.INSTANCE.putBlock(LegacyBlocks.ARAUCARIA_SAPLING, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(LegacyBlocks.CLADOXY_SAPLING, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(LegacyBlocks.KOKIA_SAPLING, RenderLayer.getCutout());
		...
		BlockRenderLayerMap.INSTANCE.putBlock(LegacyBlocks.FLOAT_GLASS, RenderLayer.getTranslucent());
