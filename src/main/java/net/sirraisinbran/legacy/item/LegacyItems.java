...
public class LegacyItems {
    ...
    public static final Item BRONZE_ALLOY = registerItem("bronze_alloy",
            new Item(new OwoItemSettings().group(LegacyMod.OTHERWORLD_GROUP).tab(3)));
    ...
    public static final Item SICKLE = registerItem("sickle",
            new SickleItem(new OwoItemSettings().group(LegacyMod.OTHERWORLD_GROUP).tab(3).maxCount(1)));

    public static final Item QUICKSAND_BUCKET = registerItem("quicksand_bucket",
            new QuicksandBucketItem(LegacyBlocks.QUICKSAND, SoundEvents.ITEM_BUCKET_EMPTY_POWDER_SNOW, new OwoItemSettings().group(LegacyMod.OTHERWORLD_GROUP).tab(3).maxCount(1)));
    ...
    public static final Item EINKORN_SEEDS = registerItem("einkorn_seeds",
            new AliasedBlockItem(LegacyBlocks.EINKORN, new OwoItemSettings().group(LegacyMod.OTHERWORLD_GROUP).tab(3)));
    public static final Item ESCENCE = registerItem("escence",
            new Item(new OwoItemSettings().group(LegacyMod.OTHERWORLD_GROUP).tab(2)));

    public static final Item PEAR = registerItem("pear",
            new Item(new OwoItemSettings().group(LegacyMod.OTHERWORLD_GROUP).tab(3).food(LegacyFoodComponents.PEAR)));
    public static final Item SOURBREAD_CHUNK = registerItem("sourbread_chunk",
            new Item(new OwoItemSettings().group(LegacyMod.OTHERWORLD_GROUP).tab(3).food(LegacyFoodComponents.SOURBREAD).maxCount(16)));
    ...
    public static final Item GABBRO_ROCK = registerItem("gabbro_rock",
            new RockItem(new OwoItemSettings().group(LegacyMod.OTHERWORLD_GROUP).tab(3)));
    ...
    public static final Item CYAN_MUSHROOM = registerItem("cyan_mushroom",
            new WallStandingCeilingBlockItem(LegacyBlocks.CYAN_MUSHROOM, LegacyBlocks.CYAN_MUSHROOM_WALL, LegacyBlocks.CYAN_MUSHROOM_CEILING, new OwoItemSettings().group(LegacyMod.OTHERWORLD_GROUP).tab(1)));
    public static final Item SCARLET_MUSHROOM = registerItem("scarlet_mushroom",
            new WallStandingCeilingBlockItem(LegacyBlocks.SCARLET_MUSHROOM, LegacyBlocks.SCARLET_MUSHROOM_WALL, LegacyBlocks.SCARLET_MUSHROOM_CEILING, new OwoItemSettings().group(LegacyMod.OTHERWORLD_GROUP).tab(1)));
    public static final Item WHITE_MUSHROOM = registerItem("white_mushroom",
            new WallStandingCeilingBlockItem(LegacyBlocks.WHITE_MUSHROOM, LegacyBlocks.WHITE_MUSHROOM_WALL, LegacyBlocks.WHITE_MUSHROOM_CEILING, new OwoItemSettings().group(LegacyMod.OTHERWORLD_GROUP).tab(1)));
    ...
    public static final Item AUROCH_SPAWN_EGG = registerItem("auroch_spawn_egg",
            new SpawnEggItem(LegacyEntities.AUROCH_ENTITY_TYPE,0x392921, 0x271618,
                    new OwoItemSettings().group(LegacyMod.OTHERWORLD_GROUP).tab(3)));
